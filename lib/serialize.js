...
const downloadMedia = async(m, conn)=>{
	
try{
/*bb is my way of saying buffer*/
let bb = await downloadMediaMessage(m, "buffer", {} , conn);
return bb//this is the buffer content;
} catch(e){
return e
}
    ...
    if (msg.message) {
        ...
        try {
            ...
            if (quoted && quoted.quotedMessage) {
                ...
                msg.quoted.download = () =>
                downloadMedia(msg.quoted.message, conn);
            }
        } catch (e) {
            console.log(e);
            msg.quoted = null;
        ...
        msg.download = () => downloadMedia(msg.message, conn);
        conn.client = msg;
        ...
        * @returns
        *
        /*IAS = Image As Sticker and VAS = video as Sticker*/
