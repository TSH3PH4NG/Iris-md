    ...
    if (msg.message) {
        ...
        try {
            ...
            if (quoted && quoted.quotedMessage) {
                ...
                if(!msg.quoted && msg.quoted.text) return `Reply to an audio, image or video.  Feature does not apply to text`;
                const bb = await downloadMediaMessage(msg.quoted , "buffer", {} , conn);
